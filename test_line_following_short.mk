test_line_following_short :  test_line_following_short.o robot_initialise.o Robot.o line_following.o Driving_Motor.o components.o
	 g++ -L/export/teach/1BRobot -o test_beacon_reader  test_beacon_reader.o  robot_initialise.o  Robot.o  line_following.o  Motor.o  components.o  -lrobot

test_line_following_short.o: test_line_following_short.cpp robot_initialise.h components.h
	 g++ -ansi -Wall -g -I/export/teach/1BRobot -c test_line_following_short.cpp
